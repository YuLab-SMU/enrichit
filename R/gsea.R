...
#' \item{PValue}{Empirical p-value from permutation test}
#' \item{Size}{Size of the gene set (number of genes found in genelist)}
#' \item{rank}{Rank at which the maximum enrichment score is attained}
#' \item{leading_edge}{Leading edge statistics (tags, list, signal)}
#' \item{core_enrichment}{Genes in the leading edge, separated by '/'}
#'
#' @examples
#' \dontrun{
#' # Example data
